...
public:
  Ammonia(): Molecule("NH3", 17.0306, 195.4, 6060.)
  {
...
public:
  Ammonia(): Molecule("NH3(l)", 17.0306, 195.4, 6060.)
  {
    phase_id_ = 1;
    enthalpy_offset_ = -23.5E3;
    shomate_func_ptr_ = get_shomate;
    svp_func_ptr_ = AmmoniaVaporPressures::svpBriggsS;
  }
...
public:
  Ammonia(): Molecule("NH3(s)", 17.0306, 195.4, 6060.)
  {
    phase_id_ = 2;
    enthalpy_offset_ = -31.2E3;
    shomate_func_ptr_ = get_shomate;
    svp_func_ptr_ = AmmoniaVaporPressures::svpBriggsS;
  }
